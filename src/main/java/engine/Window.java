...
public class Window {
    ...
    private boolean cursorInGame = false;
    ...
    public boolean isCursorInGame() {
        return cursorInGame;
    }

    public void setCursorInGame(boolean cursorInGame) {
        this.cursorInGame = cursorInGame;
    }

    public void update() {
        if (glfwGetKey(windowHandle, GLFW_KEY_ESCAPE) == GLFW_PRESS && !escClicked) {
            System.out.println(isCursorInGame());
            if (cursorInGame) {
                glfwSetInputMode(windowHandle, GLFW_CURSOR, GLFW_CURSOR_NORMAL);
                setCursorInGame(false);
            } else {
                glfwSetWindowShouldClose(windowHandle, true);
            }
            escClicked = true;
        } else if(glfwGetKey(windowHandle, GLFW_KEY_ESCAPE) == GLFW_RELEASE) {
            escClicked = false;
        }
